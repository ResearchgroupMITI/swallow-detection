...
def build_configargparser(parser):
    ...
    dataset_group.add_argument("--data_root", type=str, default="/media/mitiadmin/Micron_7450_1/lars/SwallowDetection/data")
    dataset_group.add_argument("--num_workers", default=0, type=int)
    dataset_group.add_argument("--man_data_path", type=str, default="/media/mitiadmin/Micron_7450_1/lars/SwallowDetection/data/sensors")
    dataset_group.add_argument("--imp_data_path", type=str, default="/media/mitiadmin/Micron_7450_1/lars/SwallowDetection/data/impedance")
